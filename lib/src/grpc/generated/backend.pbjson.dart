...
final $typed_data.Uint8List streamSensorValuesRequestDescriptor = $convert.base64Decode('ChlTdHJlYW1TZW5zb3JWYWx1ZXNSZXF1ZXN0EiIKBGZlZWQYASABKAsyDi5wcm90b2J1Zi5GZWVkUgRmZWVk');
...
final $typed_data.Uint8List streamActuatorStatesRequestDescriptor = $convert.base64Decode('ChtTdHJlYW1BY3R1YXRvclN0YXRlc1JlcXVlc3QSIgoEZmVlZBgBIAEoCzIOLnByb3RvYnVmLkZlZWRSBGZlZWQ=');
...
final $typed_data.Uint8List deleteFeedRequestDescriptor = $convert.base64Decode('ChFEZWxldGVGZWVkUmVxdWVzdBIiCgRmZWVkGAEgASgLMg4ucHJvdG9idWYuRmVlZFIEZmVlZA==');
...
final $typed_data.Uint8List streamNotificationsRequestDescriptor = $convert.base64Decode('ChpTdHJlYW1Ob3RpZmljYXRpb25zUmVxdWVzdBIiCgRmZWVkGAEgASgLMg4ucHJvdG9idWYuRmVlZFIEZmVlZA==');
...
const StreamNotificationsResponse$json = const {
  ...
  '2': const [
    const {'1': 'notification', '3': 1, '4': 1, '5': 11, '6': '.protobuf.Notification', '10': 'notification'},
  ],
};

/// Descriptor for `StreamNotificationsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List streamNotificationsResponseDescriptor = $convert.base64Decode('ChtTdHJlYW1Ob3RpZmljYXRpb25zUmVzcG9uc2USOgoMbm90aWZpY2F0aW9uGAEgASgLMhYucHJvdG9idWYuTm90aWZpY2F0aW9uUgxub3RpZmljYXRpb24=');
...
const UpdateFeedConfigRequest$json = const {
  ...
  '2': const [
    const {'1': 'config', '3': 1, '4': 1, '5': 11, '6': '.protobuf.Config', '10': 'config'},
  ],
};

/// Descriptor for `UpdateFeedConfigRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateFeedConfigRequestDescriptor = $convert.base64Decode('ChdVcGRhdGVGZWVkQ29uZmlnUmVxdWVzdBIoCgZjb25maWcYASABKAsyEC5wcm90b2J1Zi5Db25maWdSBmNvbmZpZw==');
...
final $typed_data.Uint8List getFeedConfigRequestDescriptor = $convert.base64Decode('ChRHZXRGZWVkQ29uZmlnUmVxdWVzdBIiCgRmZWVkGAEgASgLMg4ucHJvdG9idWYuRmVlZFIEZmVlZA==');
...
const FeedsChange$json = const {
  '1': 'FeedsChange',
  '2': const [
    const {'1': 'addeds', '3': 1, '4': 3, '5': 11, '6': '.protobuf.Feed', '10': 'addeds'},
    const {'1': 'removedIDs', '3': 2, '4': 3, '5': 9, '10': 'removedIDs'},
  ],
};

/// Descriptor for `FeedsChange`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List feedsChangeDescriptor = $convert.base64Decode('CgtGZWVkc0NoYW5nZRImCgZhZGRlZHMYASADKAsyDi5wcm90b2J1Zi5GZWVkUgZhZGRlZHMSHgoKcmVtb3ZlZElEcxgCIAMoCVIKcmVtb3ZlZElEcw==');
@$core.Deprecated('Use configDescriptor instead')
const Config$json = const {
  '1': 'Config',
  '2': const [
    const {'1': 'feedConfig', '3': 1, '4': 1, '5': 11, '6': '.protobuf.Feed', '10': 'feedConfig'},
    const {'1': 'sensorConfig', '3': 2, '4': 1, '5': 11, '6': '.protobuf.SensorConfig', '9': 0, '10': 'sensorConfig'},
    const {'1': 'actuatorConfig', '3': 3, '4': 1, '5': 11, '6': '.protobuf.ActuatorConfig', '9': 0, '10': 'actuatorConfig'},
  ],
  '8': const [
    const {'1': 'typeConfig'},
  ],
...
final $typed_data.Uint8List configDescriptor = $convert.base64Decode('');
...
const ActuatorConfig$json = const {
  ...
  '2': const [
    ...
    const {'1': 'turnOnCronExpr', '3': 2, '4': 1, '5': 9, '10': 'turnOnCronExpr'},
    const {'1': 'turnOffCronExpr', '3': 3, '4': 1, '5': 9, '10': 'turnOffCronExpr'},
  ],
};

/// Descriptor for `ActuatorConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List actuatorConfigDescriptor = $convert.base64Decode('Cg5BY3R1YXRvckNvbmZpZxIcCglhdXRvbWF0aWMYASABKAhSCWF1dG9tYXRpYxImCg50dXJuT25Dcm9uRXhwchgCIAEoCVIOdHVybk9uQ3JvbkV4cHISKAoPdHVybk9mZkNyb25FeHByGAMgASgJUg90dXJuT2ZmQ3JvbkV4cHI=');
